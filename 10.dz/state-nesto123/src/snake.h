...
public:
    ...
    void setDirection(Direction dir){
        if( mdir == Direction::Down && dir == Direction::Up ||
             mdir == Direction::Up && dir == Direction::Down ||
                mdir == Direction::Left && dir == Direction::Right ||
                mdir == Direction::Right && dir == Direction::Left )
            return;
         else
                mdir = dir;
    }
